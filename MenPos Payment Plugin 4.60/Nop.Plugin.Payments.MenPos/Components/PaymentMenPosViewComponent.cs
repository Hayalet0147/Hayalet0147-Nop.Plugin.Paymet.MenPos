...
namespace Nop.Plugin.Payments.MenPos.Components
{
    public class PaymentMenPosViewComponent : NopViewComponent
    {
        ...
        public PaymentMenPosViewComponent(IParamPaymentSettings paramPaymentSettings,
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            var belirlenen_ara_tutar = _otherPaymentSettings.ara_tutar;
            var belirlenen_ust_tutar = _otherPaymentSettings.ust_tutar;
            ViewBag.aratutar = belirlenen_ara_tutar;
            ViewBag.usttutar = belirlenen_ust_tutar; 
            ...
            ViewBag.SubTotalStrm = cartTotal.SubTotalValue;
            ...
            if (Request.Method == WebRequestMethods.Http.Get)
                return View("~/Plugins/Payment.MenPos/Views/PaymentInfo.cshtml", model);
